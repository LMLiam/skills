...
- Added `opencode-mixed` provider profile: a flat, index-ordered ladder of thirteen advisor tiers spanning model families (GPT-5.6, Gemini, Claude, Grok) via OpenCode Zen, ordered by the Artificial Analysis Intelligence Index with price as the tiebreak.
